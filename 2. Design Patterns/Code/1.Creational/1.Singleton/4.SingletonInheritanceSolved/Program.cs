namespace _4.SingletonInheritanceSolved;
...
public sealed class Singleton
{
    ...
    /*
    // Compilation error! : Cannot derive from a sealed class
    public class DerivedClass : Singleton
    {
        // The derived class constructor calls the base class constructor.
        // Since the derived class is nested inside Singleton class, it can call the private base class constructor.
